                ...
                <div class="menu">
                    <ul class="">
                        ...
                        <li class="hover_menu only_04">
                            <button class="dropbtn"><a href="javascript:alert('준비중입니다.');" onfocus="this.blur()">ALUMNI</a></button>
                    ...
                    <div id="mo_nav" class="overlay">
                        ...
                        <div class="overlay_content">
                            <ul class="show">
                                ...
                                <li class="first">
                                    <a href="javascript:alert('준비중입니다.');" onfocus="this.blur()">ALUMNI</a>
                                </li>
                                <li>
